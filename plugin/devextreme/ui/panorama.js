...
var Panorama = CollectionWidget.inherit({
    ...
    _initSwipeHandlers: function() {
        ...
        }, this._swipeStartHandler.bind(this)).on(eventUtils.addNamespace(swipeEvents.swipe, this.NAME), this._swipeUpdateHandler.bind(this)).on(eventUtils.addNamespace(swipeEvents.end, this.NAME), this._swipeEndHandler.bind(this))
    },
